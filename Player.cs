...
public class AllLevelPlayerData
{
    ...
    public void InitializePlayer1WeaponData()
    {
        ...
        player1WeaponData[7].extraBulletsPerSide = 10;
    ...
    public void InitializePlayer2WeaponData()
    {
        ...
        player2WeaponData[7].shootInterval = 0.14f;
        player2WeaponData[7].extraBulletsPerSide = 3;
        ...
        player2WeaponData[9].extraBulletsPerSide = 4;
        ...
        player2WeaponData[10].extraBulletsPerSide = 5;
        ...
        player2WeaponData[12].extraBulletsPerSide = 6;
        ...
        player2WeaponData[13].extraBulletsPerSide = 7;
        ...
        player2WeaponData[17].extraBulletsPerSide = 11;
...
public class Player
{
    ...
    public void Load()
    {
        if (index == 0) obj.transform.localPosition = new Vector3(-10.3f, 0.5f, 0.0f);
        else obj.transform.localPosition = new Vector3(10.3f, 0.5f, 0.0f);
