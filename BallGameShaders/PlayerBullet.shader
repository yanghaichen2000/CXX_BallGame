Shader "Ball Game/Player Bullet New"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Scripts/BallGameShaders/PlayerBulletForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Includes
            #include "Packages/com.unity.render-pipelines.universal/Shaders/UnlitInput.hlsl"
            #include "Assets/Scripts/BallGameShaders/PlayerBulletDepthNormalsPass.hlsl"
            ENDHLSL
        }
